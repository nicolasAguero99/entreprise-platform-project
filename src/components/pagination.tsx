...
// Types
import { ActionTypes, type PaginationProps } from '@/types/types.d'

// Services
import { createQueryParams } from '@/lib/utils'

export default function Pagination ({ paginationPages, prev, next, page, search }: PaginationProps): JSX.Element {
